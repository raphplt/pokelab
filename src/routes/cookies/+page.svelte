<div class="max-w-3xl mx-auto bg-white p-4 rounded-lg shadow-md mt-24 mb-24">
	...
	<ul>
		<li>
			...
			cette Politique relative aux cookies) fait référence à Pokélab.
		</li>
		<li>
			<strong>Cookies</strong> désigne de petits fichiers placés sur votre ordinateur, votre appareil
			mobile ou tout autre appareil par un site web, contenant des détails sur votre historique de navigation
			sur ce site parmi ses nombreuses utilisations.
		</li>
		<li>
			<strong>Site web</strong> fait référence à Pokélab, accessible depuis
			<a href="/" rel="external nofollow noopener" target="_blank"> https://www.pokélab.fr </a>
		</li>
		<li>
			<strong>Vous</strong> désigne l&apos;entité légale au nom de laquelle cet individu accède ou utilise
	...
	<p>
		...
		persistants demeurent sur votre ordinateur personnel ou votre appareil mobile lorsque vous êtes
		hors ligne, tandis que les cookies de session sont supprimés dès que vous fermez votre
		navigateur web.
	</p>
	<p>
	...
	<ul>
		<li>
			...
			<p>
				...
				site web et vous permettre d&apos;utiliser certaines de ses fonctionnalités. Ils contribuent
				à authentifier les utilisateurs et à prévenir toute utilisation frauduleuse des comptes
				d&apos;utilisateur. Sans ces cookies, les services que vous avez demandés ne peuvent pas
				être fournis, et nous n&apos;utilisons ces cookies que pour vous fournir ces services.
			</p>
		</li>
		<li>
			<p>
			...
			<p>
				...
				personnelle et d&apos;éviter que vous ayez à réintroduire vos préférences à chaque fois que
	...
	<p>
		...
		enregistrés dans votre navigateur associés à ce site web. Vous pouvez utiliser cette option pour
		empêcher l&apos;utilisation de cookies à tout moment.
	</p>
	<p>
